...
-- CreateTable
CREATE TABLE "public"."todos_no_rls" (
    "id" BIGSERIAL NOT NULL,
    ...
    CONSTRAINT "todos_no_rls_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."todos_with_rls" (
    "id" BIGSERIAL NOT NULL,
    "content" TEXT,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "todos_with_rls_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."todos_with_rls" ADD CONSTRAINT "todos_with_rls_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
